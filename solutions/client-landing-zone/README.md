...
| client-name                        | client1                                                                                                                                                                                                                            | str   |   190 |
| denied-sanctioned-countries        | ["CU", "IR", "KP", "SY"]                                                                                                                                                                                                           | array |     1 |
| dns-name                           | client-name.example.com.                                                                                                                                                                                                           | str   |     4 |
| dns-nameservers                    | ["ns-cloud-a1.googledomains.com.", "ns-cloud-a2.googledomains.com.", "ns-cloud-a3.googledomains.com.", "ns-cloud-a4.googledomains.com."]                                                                                           | array |     2 |
...
| client-folder/standard/applications-infrastructure/host-project/network/public-dns.yaml                                                 | dns.cnrm.cloud.google.com/v1beta1             | DNSRecordSet                     | client-name-standard-public-dns-ns-rset                                                    | client-name-networking |
| client-folder/standard/applications-infrastructure/host-project/network/public-dns.yaml                                                 | dns.cnrm.cloud.google.com/v1beta1             | DNSRecordSet                     | client-name-standard-public-dns-soa-rset                                                   | client-name-networking |
...
| client-folder/standard/firewall-policy/rules/network-isolation.yaml                                                                     | compute.cnrm.cloud.google.com/v1beta1         | ComputeFirewallPolicyRule        | client-name-standard-fwpol-isolate-unclassified-fwr                                        | client-name-networking |
