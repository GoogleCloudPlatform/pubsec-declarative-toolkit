...
Use the new "All Products" page for a list of Google Cloud Services [products](https://console.cloud.google.com/products)
...
###### Details
- see [ORG policy - defining locations](https://cloud.google.com/resource-manager/docs/)organization-policy/defining-locations
...
### Guardrails Subset
see - [Guardrails](https://github.com/canada-ca/cloud-guardrails/tree/master/EN)
