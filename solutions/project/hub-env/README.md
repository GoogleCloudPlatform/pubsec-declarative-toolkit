...
A hub project that implements the Hub from the Hub and Spoke network design. 
...
| hub-project-id  | xxdmu-admin1-projectname                                                                    | str  |    67 |
...
1.  Clone the package:
    ```shell
    kpt pkg get https://github.com/GoogleCloudPlatform/pubsec-declarative-toolkit.git/solutions/hub@${VERSION}
    ```
