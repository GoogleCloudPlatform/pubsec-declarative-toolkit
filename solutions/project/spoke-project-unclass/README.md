...
A shared vpc project that implements the Spoke from the Hub and Spoke network design.
...
| project-id            | xxdmu-admin1-projectname | str  |    80 |
...
| network/dns.yaml      | dns.cnrm.cloud.google.com/v1beta1             | DNSManagedZone              | project-id-googleapis                     | networking |
| network/dns.yaml      | dns.cnrm.cloud.google.com/v1beta1             | DNSRecordSet                | project-id-googleapis-root-record-set     | networking |
| network/dns.yaml      | dns.cnrm.cloud.google.com/v1beta1             | DNSRecordSet                | project-id-googleapis-wildcard-record-set | networking |
| network/dns.yaml      | dns.cnrm.cloud.google.com/v1beta1             | DNSManagedZone              | project-id-gcrio                          | networking |
| network/dns.yaml      | dns.cnrm.cloud.google.com/v1beta1             | DNSRecordSet                | project-id-gcrio-root-record-set          | networking |
| network/dns.yaml      | dns.cnrm.cloud.google.com/v1beta1             | DNSRecordSet                | project-id-gcrio-wildcard-record-set      | networking |
| network/firewall.yaml | compute.cnrm.cloud.google.com/v1beta1         | ComputeFirewall             | spoke-default-egress-deny                 | networking |
| network/firewall.yaml | compute.cnrm.cloud.google.com/v1beta1         | ComputeFirewall             | spoke-psc-egress-allow                    | networking |
...
| network/psc.yaml      | compute.cnrm.cloud.google.com/v1beta1         | ComputeAddress              | apis-private-ip                           | networking |
| network/psc.yaml      | compute.cnrm.cloud.google.com/v1beta1         | ComputeForwardingRule       | endpoint1                                 | networking |
...
| project.yaml          | compute.cnrm.cloud.google.com/v1beta1         | ComputeSharedVPCHostProject | project-id-host-vpc                       | networking |
...
1.  Clone the package:
    ```shell
    kpt pkg get https://github.com/GoogleCloudPlatform/pubsec-declarative-toolkit.git/solutions/project/spoke-project-unclass@${VERSION}
    ```
...
1.  Move into the local package:
    ```shell
    cd ".//solutions/project/spoke-project-unclass/"
    ```
